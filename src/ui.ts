...
function renderLanguageSelector(): void {
    ...
    html += `<button class="lang-btn lang-more${languageExpanded ? ' lang-active' : ''}" data-lang="more" title="More languages" aria-expanded="${languageExpanded}" aria-label="More languages">
